...
SYSTEM_TEMPLATE_EVALUATION = """
    ...
    以下の「LLMによる問題文」と「ユーザーによる回答文」を比較してください。
...
"""
SYSTEM_TEMPLATE_EVALUATION_WITH_CRITERIA = """
    あなたは英語学習者向けの評価アシスタントです。
    以下の観点に基づいて評価してください。
    1. 意味が正しく伝わっているか
    2. 文法的に大きな誤りがないか
    3. 学習者レベル（{english_level}）として許容範囲か
